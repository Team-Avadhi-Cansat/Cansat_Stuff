...
#define CSB 10 // Chip Select pin for BMP280

MPU9250_asukiaaa mpu;
Adafruit_BMP280 bmp(CSB); // Initialize BMP280 with SPI
...
void setup() {
  ...
  Wire.begin(); // Initialize I2C on default pins (SDA=18, SCL=19 on Teensy 4.1)
  delay(100);   // Allow I2C devices to initialize properly
...
void loop() {
  ...
  altitude = bmp.readAltitude(1031.25);  // Adjust based on local pressure
  ...
  delay(500); // Reduce delay for Teensy's higher speed
}
